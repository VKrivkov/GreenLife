  ...
  return (
    ...
    <div className='location-gallery'>
        <div className='location-gallery-header'> 
            ...
            <p className='first'>{t('company.p2')} {t('company.p3')} <a href='https://www.instagram.com/vershky_villas?igsh=aGg0MmR1MXVvcjR0&utm_source=qr' style={{fontWeight:"500", textDecoration:"underline", color:"#B3A57C"}}><label style={{cursor:"pointer"}}>Vershky Villas</label></a>, {t('company.li1')}; <a href='https://www.instagram.com/porto_buro?igsh=OHRvMDNrYXplcXQ5' style={{fontWeight:"500", textDecoration:"underline", color:"#B3A57C"}}><label style={{cursor:"pointer"}}>Park Residences</label></a>, {t('company.li2')} </p>
